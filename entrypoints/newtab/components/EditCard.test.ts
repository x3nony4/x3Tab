...
describe('EditCard', () => {
    describe('render modes', () => {
        it('renders create mode title and empty fields', () => {
            const wrapper = mount(EditCard, { props: { shortcut: null } })
        ...
        it('renders edit mode title and pre-filled fields', () => {
            const wrapper = mount(EditCard, {
                props: { shortcut: makeShortcut({ name: 'MyApp', url: 'https://myapp.com' }) },
            })
    ...
    describe('icon type conditional UI', () => {
        it('shows color picker when solid is selected', () => {
            const wrapper = mount(EditCard, {
                props: { shortcut: makeShortcut({ iconType: 'solid' }) },
            })
        ...
        it('shows file input when upload is selected', () => {
            const wrapper = mount(EditCard, {
                props: { shortcut: makeShortcut({ iconType: 'upload' }) },
            })
        ...
        it('shows helper text when online is selected', () => {
            const wrapper = mount(EditCard, {
                props: { shortcut: makeShortcut({ iconType: 'online' }) },
            })
    ...
    describe('cancel emit', () => {
        ...
        it('emits cancel on overlay click', async () => {
            const wrapper = mount(EditCard, { props: { shortcut: null } })
            await wrapper.find('[data-overlay]').trigger('click')
            expect(wrapper.emitted('cancel')).toHaveLength(1)
        })
    })
    ...
    describe('solid color', () => {
        ...
        it('uses provided solidColor in edit mode', () => {
            const wrapper = mount(EditCard, {
                props: { shortcut: makeShortcut({ iconType: 'solid', solidColor: '#00ff00' }) },
            })
